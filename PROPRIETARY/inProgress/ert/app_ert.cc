...
/*static*/ void read_eprom_and_init() {
	...
	// note that this negative / positive reporting is a GENESIS relic,
	// no ESN registration, no use for it. Likely, we'll clean it out
	// if only the ESN registration confirms obsolete.
